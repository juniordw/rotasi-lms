  ...
  if (user) {
    if (user.role === 'student') {
      navItems = [
        ...
        { href: '/dashboard/certificates', label: 'Sertifikat', icon: <FiAward /> },
        { href: '/dashboard/discussions', label: 'Diskusi', icon: <FiMessageSquare /> },
      ];
      ...
      navItems = [
        ...
        { href: '/dashboard/discussions', label: 'Diskusi', icon: <FiMessageSquare /> },
        { href: '/dashboard/analytics', label: 'Analitik', icon: <FiBarChart2 /> },
      ];
      ...
      navItems = [
        ...
        { href: '/dashboard/categories', label: 'Kategori', icon: <FiBarChart2 /> },
      ];
    }
  }
